...
<body>
<p class="img-st"> تغيير الصورة <?php echo $_SESSION['name'] ;?> </p>
	<?php
...
if(!isset($error))
{
	if($file!='')
	{
		$res=mysqli_query($conn,"SELECT* from `students` WHERE name='$st_name' ");
...
$result=mysqli_query($conn,"UPDATE `students` SET img='$image_file' WHERE name='$st_name'"); 
