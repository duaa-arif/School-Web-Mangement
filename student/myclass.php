...
a{
   ...
   <h1 style="text-align:center ;">معلومات الصفوف الخاصة بي</h1>
...
<tbody>
    ...
    <td  onmouseover="this.style.backgroundColor='#DAA520';" onmouseout="this.style.backgroundColor='';"><?php  echo ucfirst($student_class_info['subj-name']);?> </td>

<td  onmouseover="this.style.backgroundColor='#DAA520';" onmouseout="this.style.backgroundColor='';"><?php  echo ucfirst($student_class_info['t-name']);?> </td>
</tr>
</tbody>
<?php } ?>
