...
//  if(isset($_POST['upload'])&&isset($_FILES['fname'])){
 ...
 $f_error=$_FILES['stfile']['error'];
    ...
    $class=$_POST['class'];
    $part=$_POST['part'];
    $sql="INSERT INTO `teacher`(`id`, `name`, `age`, `phone`, `classid`, `partid`, `img`)
     VALUES ('','$name','$age','$phone','$class','$part','$f_name')";
                ...
                <div class="login-page" >
                    ...
                    <form  method="POST"  enctype="multipart/form-data"class="form" style="width: 70%; top:35px;;text-align:center;display:inline-block;background-color:#e09f3e;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="usermail" placeholder="  " required="required"  name="address"/>
                        <div class="form-group">
                            <label for="subject" class="iconic quote-alt"> الايميل   <span class="required">*</span></label>
                            <input type="text" class="form-control" name="email" id="subject"  required="required" placeholder="الشعبة "/>
                            <div class="form-group">
                            <label for="subject" class="iconic quote-alt"> الرمز السري   <span class="required">*</span></label>
                            <input type="password" class="form-control" name="part" id="subject"  required="required" placeholder="الشعبة "/>
                            <div class="form-group">
